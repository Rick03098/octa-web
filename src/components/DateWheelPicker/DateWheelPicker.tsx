// [INPUT] React hooks, embla-carousel-react, 日期选择器的props(values, selectedValue等), CSS Modules样式
// [OUTPUT] DateWheelPicker组件, 使用Embla Carousel实现iOS风格滚轮选择器, 支持惯性滚动和无限循环
// [POS] 组件层的日期滚轮选择器组件, 专门用于生日输入页和出生时间输入页等场景
